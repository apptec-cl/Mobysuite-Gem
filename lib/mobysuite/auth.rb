class AuthorizationGc2
    ...
    def initialize domain, client_id=nil, client_secret=nil, grant_type="client_credentials"
      self.domain        = domain
      self.client_id     = ENV["MOBYSUITE_GC2_CLIENT_ID"].blank? ? client_id : ENV["GC2_CLIENT_ID"]
      self.client_secret = ENV["MOBYSUITE_GC2_CLIENT_SECRET"].blank? ? client_secret : ENV["MOBYSUITE_GC2_CLIENT_SECRET"] 
      self.token         = nil
